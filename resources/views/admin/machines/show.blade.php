...
@else
    ...
    <div id="table-body" class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1">
            ...
            <a class="col-xs-1" style="text-align: center" href="{{ route('admin-machines-update', $machines[$i]->Id) }}"><i class="fa fa-pencil" aria-hidden="true" style="line-height: 40px;"></i></a>
        </div>
        @endfor
    </div>
@endif
