...
<form method="post" class="input-form col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3">
    ...
    <div class="row form-group">
        ...
        <input class="col-xs-12 col-sm-8" id="Code" name="Code" type="text" value="{{ old('Code') }}" placeholder="Area Code"/> 
    </div>
    
    <div class="row form-group">
        <label class="col-xs-12 col-sm-4" for="Name"><strong>Area Name</strong></label>
        <input class="col-xs-12 col-sm-8" id="Name" name="Name" type="text" value="{{ old('Name') }}" placeholder="Area Name"/> 
    </div>
