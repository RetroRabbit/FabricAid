...
<form method="post" class="input-form col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3">
    ...
    <div class="row form-group">
        ...
        <input class="col-xs-12 col-sm-8" id="FirstName" name="FirstName" type="text" value="{{ old('FirstName') }}" placeholder="John"/> 
    </div>
    
    <div class="row form-group">
        <label class="col-xs-12 col-sm-4" for="LastName"><strong>Last Name</strong></label>
        <input class="col-xs-12 col-sm-8" id="LastName" name="LastName" type="text" value="{{ old('LastName') }}" placeholder="Doe"/> 
    </div>
    
    <div class="row form-group">
        <label class="col-xs-12 col-sm-4" for="Email"><strong>Email</strong></label>
        <input class="col-xs-12 col-sm-8" id="Email" name="Email" type="email" value="{{ old('Email') }}" placeholder="jdoe@domain.com"/> 
    </div>
    
    <div class="row form-group">
        <label class="col-xs-12 col-sm-4" for="Password"><strong>Password</strong></label>
        <input class="col-xs-12 col-sm-8" id="Password" name="Password" type="text" value="{{ old('Password') }}" placeholder="somepass"/> 
    </div>
    
    <div class="row form-group">
        <label class="col-xs-12 col-sm-4" for="RoleId"><strong>User Role</strong></label>
        <select class="col-xs-12 col-sm-8" id="RoleId" name="RoleId" value="{{ old('RoleId') }}">
    ...
    <div class="row form-group">
        ...
        <select class="col-xs-12 col-sm-8" id="ArtisanTypeId" name="ArtisanTypeId" value="{{ old('ArtisanTypeId') }}">
