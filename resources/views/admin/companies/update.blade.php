...
<form method="post" class="input-form col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3">
    ...
    <div class="row form-group">
        ...
        <input class="col-xs-12 col-sm-8" id="Code" name="Code" type="text" value="{{ $company->Code }}" placeholder="JHB-S1"/> 
    </div>
    
    <div class="row form-group">
        <label class="col-xs-12 col-sm-4" for="Name"><strong>Company Name</strong></label>
        <input class="col-xs-12 col-sm-8" id="Name" name="Name" type="text" value="{{ $company->Name }}" placeholder="Johanesburg Site 1"/> 
    </div>
    
    <div class="row form-group">
        <label class="col-xs-12 col-sm-4" for="Description"><strong>Company Description</strong></label>
        <input class="col-xs-12 col-sm-8" id="Description" name="Description" type="text" value="{{ $company->Description }}" placeholder="Description..."/> 
    </div>
