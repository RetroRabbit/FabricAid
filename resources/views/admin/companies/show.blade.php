...
<div class="container" style="margin-top: 100px;">
    <div id="table-header" class="row"> 
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1 form-group"> 
            ...
            <p class="col-xs-3"><strong>Company Description</strong></p>
    ...
    <div id="table-body" class="row"> 
        ...
        <form class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1 form-group" method="post" action="{{ route('admin-companies-update', $companies[$i]->Id) }}"> 
            {{ csrf_field() }} 

            <label class="col-xs-1">{{ $i + 1 }}</label> 
            ...
            <input class="col-xs-3" name="Description" type="text" value="{{ $companies[$i]->Description }}" placeholder="Description..."/> 
            <input class="col-xs-2" name="Logo" type="file" value="{{ $companies[$i]->Logo }}" /> 
            <button type="submit" name="Submit" class="col-xs-1" style="border: 0; background: none;"><i class="fa fa-upload" aria-hidden="true"></i></button>
    ...
    <form id="table-footer" class="row" method="post" action="{{ route('admin-companies-create') }}"> 
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-lg-offset-1 form-group"> 
            <label class="col-xs-1">New</label> 
            ...
            <input class="col-xs-3" name="Description" type="text" value="{{ old('Description') }}" placeholder="Description..."/> 
